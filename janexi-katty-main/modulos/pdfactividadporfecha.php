<?php
if(isset($_GET['actividad']) && !empty($_GET['actividad']) && isset($_GET['fecha']) && !empty($_GET['fecha']))
{
...
$this->Cell(0,5,'Registros De '.$this->acti." por fecha",0,1,'C');
$this->Ln(3);
...
$base = new actividad();
$misDatos = $base->ExtraerActividadPorFecha($actividad,$fecha);
...
$pdf->Ln();
$pdf->Cell(0,8,'Cantidad : '.$misDatos[0]['cantidad'],0,1);

$pdf->Output($actividad." por Fecha.pdf","D");

}else{
    echo "<h3>Error al obtener datos</h3>";
}
?>