...
$this->Cell(0,5,utf8_decode('Registros De Campañas Masivas'),0,1,'C');
$this->Ln(3);
...
function cabeceraHorizontal($cabecera)
    {
        ...
        $this->SetFillColor(10, 162, 83);//Fondo verde
...
$base = new actividad();
$misDatos = $base->ExtraerActividades($actividades="Campana Masiva");
...
$pdf->Output("Registros De Campañas Masivas.pdf","D");
?>