...
$this->Cell(0,5,'Registros De Miembros No Activos',0,1,'C');
$this->Ln(3);
...
function cabeceraHorizontal($cabecera)
    {
        ...
        $this->CellFitSpace(63.75,6, utf8_decode($cabecera[0]),1, 0 , 'C', true);
        $this->CellFitSpace(63.75,6,utf8_decode($cabecera[1]),1,0,'C',true);
        $this->CellFitSpace(63.75,6,utf8_decode($cabecera[2]),1,0,'C',true);
        $this->CellFitSpace(63.75,6,utf8_decode($cabecera[3]),1,0,'C',true);
    ...
    function datosHorizontal($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(63.75,8, utf8_decode($fila['nombres']),1, 0 , 'C', $bandera );
            $this->CellFitSpace(63.75,8, utf8_decode($fila['apellidos']),1, 0 , 'C', $bandera );
            $this->CellFitSpace(63.75,8, utf8_decode($fila['cedula']),1, 0 , 'C', $bandera );
            $this->CellFitSpace(63.75,8, utf8_decode($fila['telefono']),1, 0 , 'C', $bandera );
...
$base = new Miembros();
$misDatos = $base->ExtraerMiebrosEliminados();

$pdf->Ln();
$pdf->SetDrawColor(230,230,230);

$miCabecera= array('Nombres','Apellidos','Cedulas','Telefonos');
...
$pdf->Output("Registros De Los Miembros No Ativo.pdf","D");
